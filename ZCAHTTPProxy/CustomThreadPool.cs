...
namespace ZCAHTTPProxy
{
    ...
    public class LowPriorityThreadPool : IThreadPool
    {
        // Constructors--
        ...
        public LowPriorityThreadPool() : this(Environment.ProcessorCount, true) { }
        public LowPriorityThreadPool(int concurrencyLevel) : this(concurrencyLevel, true) { }
        public LowPriorityThreadPool(bool flowExecutionContext) : this(Environment.ProcessorCount, flowExecutionContext) { }
        public LowPriorityThreadPool(int concurrencyLevel, bool flowExecutionContext)
        {
                ...
                lock (m_queue)
                {
                    if (m_threads == null)
                    {
                        ...
                        for (int i = 0; i < m_threads.Length; i++)
                        {
                            ...
                            m_threads[i].Priority = ThreadPriority.Lowest;
